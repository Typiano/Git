...
```
cd existing_repo
git remote add origin https://gitlab.com/htwk-fdit/bell/bell-hofmann.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/htwk-fdit/bell/bell-hofmann/-/settings/integrations)
